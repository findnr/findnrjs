module.exports=function CreateFloatAnimation(className=""){
    ...
    let showh= (document.documentElement.clientHeight || document.body.clientHeight)-elObj.offsetHeight;
    let showw= (document.documentElement.clientWidth || document.body.clientWidth)-elObj.offsetWidth;
    ...
    elObj.addEventListener('mouseover',function (event){
         event.stopPropagation();
         clearInterval(createAction);
    },false)
    elObj.addEventListener('mouseleave',function (){
         event.stopPropagation();
